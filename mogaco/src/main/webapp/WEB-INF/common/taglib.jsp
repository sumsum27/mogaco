...
<link rel="shortcut icon" href="${pageContext.request.contextPath}/assets/images/logo2.png" type="image/x-icon">
...
<script src="${pageContext.request.contextPath}/assets/jquery-mb-ytplayer/jquery.mb.ytplayer.min.js"></script>
