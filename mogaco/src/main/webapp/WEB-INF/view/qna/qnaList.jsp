...
<div class="container" style="max-width: 1050px;">
    ...
    <div class="row" style="margin: 0 auto; ">
         <!--<div class="col-md-7">
             <a href="#">
            <img class="img-fluid rounded mb-3 mb-md-0" src="http://placehold.it/400x240" alt="">
            </a> 
        </div> --> <!-- class="col-md-5" --> 
        <div style="font-size:35px; min-width:800px;" >
            <span > <a style="min-width:500px;" href="../qna/qnaView.do?num=${list.num}">${list.title}</a> </span>
        	<span > ${list.id}</span>
            <span style="color:#9b9b9b; font-size:30px;" >${list.date}</span>
