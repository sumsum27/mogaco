...
<div class="container" style="max-width: 1050px; margin-top:100px;">
    ...
    <div class="row" style="margin: 0 auto;">
        ...
        <div class="col-md-5" style="min-width:900px;">
            ...
            <p style="color:#9b9b9b; font-size:25px;">Posted  ${qnaView.date}</p> <!-- 시간까지 디비 변경 -->
            <!-- 에디터 넣기 -->
            <br>
            <div id="qnaView_contents" style="min-height:400px;">
	            ${qnaView.contents}            
            </div>
			<a href="../qna/qnaInsert.do">공지사항 글쓰기</a> <br>
			<a href="../qna/qnaUpdate.do?num=${qnaView.num}">수정</a>	 
			<a href="../qna/qnaDelete.do?num=${qnaView.num}">삭제</a> <!-- 다시한번 묻기 -->
			<!-- 다시 목록으로 , -->
